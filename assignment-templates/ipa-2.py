...
def caesar_cipher(message, shift):
    ...
    for letter in message:
        if letter.isalpha():
            ...
            shifted_index = (letter_index + shift) % alphabet_length
            shifted_letter = alphabet[shifted_index]
            shifted_message += shifted_letter if letter_uppercase else shifted_letter.lower()
        else:
...
def shift_by_letter(letter, letter_shift):
    ...
    shifted_index = (letter_index + letter_shift_index) % len(alphabet)
    shifted_letter = alphabet[shifted_index]
    return shifted_letter
